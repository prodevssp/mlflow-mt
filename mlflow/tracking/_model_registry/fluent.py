...
def register_model(
    model_uri, name, team_id=None, await_registration_for=DEFAULT_AWAIT_MAX_SLEEP_SECONDS
) -> ModelVersion:
    """
    ...
    client = MlflowClient()
    try:
        create_model_response = client.create_registered_model(name, team_id=team_id)
